...
/**
 * @wordpress-plugin
 * Plugin Name:       Goopter Advanced Payment for WooCommerce and PayPal Complete Payment
 ...
 * Text Domain:       goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment
...
if (!class_exists('Goopter_Gateway_Paypal')) {
    ...
    class Goopter_Gateway_Paypal {
        ...
        protected $plugin_slug = 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment';
        ...
        public function plugin_action_links($actions, $plugin_file, $plugin_data, $context) {
            ...
            $base_url = admin_url('options-general.php?page=goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment');
            ...
            $configure = sprintf('<a href="%s">%s</a>', $configure_url, __('Configure', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'));
            $custom_actions = array(
                'configure' => $configure,
                'contact' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://www.goopter.com/contact-us/', __('Contact', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment')),
            );
        ...
        public function admin_scripts() {
            ...
            $translation_array = array(
                ...
                'choose_image' => __('Choose Image', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'),
        ...
        public function goopter_admin_menu_own() {
            $this->plugin_screen_hook_suffix = add_submenu_page(
                    'options-general.php',
                    __('PayPal for WooCommerce - Settings', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'),
                    GT_PPCP_NAME,
                    'manage_options',
        ...
        public function load_plugin_textdomain() {
            load_plugin_textdomain('goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment', false, plugin_basename(dirname(PAYPAL_FOR_WOOCOMMERCE_PLUGIN_FILE)) . '/i18n/languages');
        }
        ...
        public function goopter_paypal_for_woo_woocommerce_product_data_tabs($product_data_tabs) {
            ...
            if (isset($gateways['goopter_ppcp']) && 'yes' === $gateways['goopter_ppcp']->enabled) {
                $product_data_tabs['goopter_paypal_for_woo_payment_action'] = array(
                    'label' => __('Payment Action', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'),
        ...
        public function goopter_wc_order_statuses($order_statuses) {
            $order_statuses['wc-partial-payment'] = _x('Partially Paid', 'Order status', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment');
            return $order_statuses;
        }

        public function goopter_register_post_status() {
            register_post_status('wc-partial-payment', array(
                'label' => _x('Partially Paid', 'Order status', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'),
                'public' => false,
                'exclude_from_search' => false,
                'show_in_admin_all_list' => true,
                'show_in_admin_status_list' => true,
                // Translators: %s is the count of partially paid items.
                'label_count' => _n_noop('Partially Paid <span class="count">(%s)</span>', 'Partially Paid <span class="count">(%s)</span>', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'),
            ));
        }
        ...
        public function goopter_redirect_to_onboard() {
            ...
            if ($woocommerce_goopter_ppcp_settings === false && $displayed_goopter_onboard_screen === false) {
                ...
                wp_safe_redirect(admin_url('options-general.php?page=goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment&tab=general_settings&gateway=paypal_payment_gateway_products'));
                exit;
            }
        }
