...
class Goopter_PayPal_PPCP_Request {
    ...
    public $basicAuth;
    public $client_token;
    public ?Goopter_PayPal_PPCP_Response $api_response;
    public $result;
    public $setting_obj;
    public $api_request;
    ...
    public function goopter_ppcp_remote_get($paypal_url, $args, $action_name) {
    ...
    public function request($url, $args, $action_name = 'default') {
        try {
            ...
            if (!str_contains($url, 'paypal.com')) {
                ...
                $args['timeout'] = '60';
                $args['user-agent'] = 'PFW_PPCP';
                $this->result = $this->goopter_ppcp_remote_get($url, $args, $action_name);
            }
    ...
    public static function goopter_ppcp_get_available_endpoints($merchant_id) {
        ...
        $seller_onboarding = Goopter_PayPal_PPCP_Seller_Onboarding::instance();
        $result = $seller_onboarding->goopter_track_seller_onboarding_status($merchant_id);
        ...
        if( goopter_is_vaulting_enable($result) ) {
