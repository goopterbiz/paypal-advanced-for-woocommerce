...
if (!function_exists('goopter_ppcp_get_payment_method_title')) {
    ...
    function goopter_ppcp_get_payment_method_title($payment_name = '') {
        ...
        $list_payment_method = array(
            ...
            'paylater' => __('PayPal Pay Later', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'),
            'paypal' => __('PayPal Checkout', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'),
            'apple_pay' => __('Apple Pay', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'),
            'google_pay' => __('Google Pay', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'),
        );
