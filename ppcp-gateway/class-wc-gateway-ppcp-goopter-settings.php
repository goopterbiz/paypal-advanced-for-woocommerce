    ...
    class WC_Gateway_PPCP_Goopter_Settings {
        ...
        public function load() {
            ...
            $defaults = array('enabled' => 'no',
                'title' => __('PayPal', 'paypal-advanced-for-woocommerce'),
                'description' => __(
                        'The easiest one-stop solution for accepting PayPal, Venmo, Debit/Credit Cards with cheaper fees than other processors!', 'paypal-advanced-for-woocommerce'
                ),
                'account_settings' => '',
                'testmode' => 'no',
                'live_onboarding' => '',
        ...
        public function goopter_ppcp_setting_fields() {
            ...
            $paymentaction_options = array(
                'capture' => __('Capture', 'paypal-advanced-for-woocommerce'),
                'authorize' => __('Authorize', 'paypal-advanced-for-woocommerce'),
            );
            $cards_list = array(
                'visa' => _x('Visa', 'Name of credit card', 'paypal-advanced-for-woocommerce'),
                'mastercard' => _x('Mastercard', 'Name of credit card', 'paypal-advanced-for-woocommerce'),
                'amex' => _x('American Express', 'Name of credit card', 'paypal-advanced-for-woocommerce'),
                'discover' => _x('Discover', 'Name of credit card', 'paypal-advanced-for-woocommerce'),
                'jcb' => _x('JCB', 'Name of credit card', 'paypal-advanced-for-woocommerce'),
                'elo' => _x('Elo', 'Name of credit card', 'paypal-advanced-for-woocommerce'),
                'hiper' => _x('Hiper', 'Name of credit card', 'paypal-advanced-for-woocommerce'),
            );
            ...
            $button_height = array(
                '' => __('Default Height (Recommended)', 'paypal-advanced-for-woocommerce')
            );
            $button_width = array(
            ...
            if ($available_endpoints === false) {
                $vaulting_advanced_text = __('Allow buyers to securely save payment details to their account. This enables features like Subscriptions, Auto-Ship, and token payments of any kind.', 'paypal-advanced-for-woocommerce');
                $this->need_to_display_paypal_vault_onboard_button = false;
                $this->is_paypal_vault_enable = false;
            } elseif (!isset($available_endpoints['vaulting_advanced'])) {
                $vaulting_advanced_text = __('The Vault functionality required for this feature is not enabled on your PayPal account.', 'paypal-advanced-for-woocommerce');
            ...
            if (isset($available_endpoints['vaulting_advanced'])) {
                ...
                $vaulting_advanced_text = __('The Vault / Subscriptions feature is enabled on your PayPal account.  You need to enable Tokenized Payments here in order this to be available on your site.', 'paypal-advanced-for-woocommerce');
            }
            if ($available_endpoints === false) {
                $applePayText = __('Allow buyers to pay using Apple Pay.', 'paypal-advanced-for-woocommerce');
                $this->need_to_display_apple_pay_button = false;
                $this->is_apple_pay_enable = false;
            } elseif (!isset($available_endpoints['apple_pay'])) {
                $applePayText = __('Apple Pay is not enabled on your PayPal account.', 'paypal-advanced-for-woocommerce');
                ...
                $applePayText = __('Apple Pay feature is enabled on your PayPal account.', 'paypal-advanced-for-woocommerce');
            }
            $apple_pay_custom_attributes = $this->is_apple_pay_approved ? [] : array('disabled' => 'disabled');

            if ($available_endpoints === false) {
                $googlePayText = __('Allow buyers to pay using Google Pay.', 'paypal-advanced-for-woocommerce');
                $this->need_to_display_google_pay_button = false;
                $this->is_google_pay_enable = false;
            } elseif (!isset($available_endpoints['google_pay'])) {
                $googlePayText = __('Google Pay is not enabled on your PayPal account.', 'paypal-advanced-for-woocommerce');
                ...
                $googlePayText = __('Google Pay feature is enabled on your PayPal account.', 'paypal-advanced-for-woocommerce');
            }
            $google_pay_custom_attributes = $this->is_google_pay_approved ? [] : array('disabled' => 'disabled');
            $applePayBtnTypes = [
                'plain' => __('Plain (Recommended)', 'paypal-advanced-for-woocommerce'),
                'buy' => __('Buy', 'paypal-advanced-for-woocommerce'),
                'donate' => __('Donate', 'paypal-advanced-for-woocommerce'),
                'book' => __('Book', 'paypal-advanced-for-woocommerce'),
                'check-out' => __('Checkout', 'paypal-advanced-for-woocommerce'),
                'subscribe' => __('Subscribe', 'paypal-advanced-for-woocommerce'),
                'contribute' => __('Contribute', 'paypal-advanced-for-woocommerce'),
                'order' => __('Order', 'paypal-advanced-for-woocommerce'),
                'reload' => __('Reload', 'paypal-advanced-for-woocommerce'),
                'rent' => __('Rent', 'paypal-advanced-for-woocommerce'),
                'support' => __('Support', 'paypal-advanced-for-woocommerce'),
                'tip' => __('Tip', 'paypal-advanced-for-woocommerce'),
                'top-up' => __('Top Up', 'paypal-advanced-for-woocommerce'),
                'continue' => __('Continue', 'paypal-advanced-for-woocommerce'),
            ];
            $this->woo_pre_order_payment_mode = array();
            $this->woo_pre_order_payment_mode['authorize'] = __('Authorize / Capture', 'paypal-advanced-for-woocommerce');
            if ($this->is_paypal_vault_enable) {
                $this->woo_pre_order_payment_mode['vault'] = __('PayPal Vault (Recommended)', 'paypal-advanced-for-woocommerce');
            }
            ...
            $this->goopter_ppcp_gateway_setting = array(
                ...
                'title' => array(
                    'title' => __('Title', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('This controls the title which the user sees during checkout.', 'paypal-advanced-for-woocommerce'),
                    'default' => __('PayPal', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ),
                'description' => array(
                    'title' => __('Description', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('Payment method description that the customer will see on your checkout.', 'paypal-advanced-for-woocommerce'),
                    'default' => __('Accept PayPal, PayPal Credit and alternative payment types.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ),
                'account_settings' => array(
                    'title' => __('PayPal Account Settings', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                    'description' => '',
                    'class' => 'ppcp_separator_heading',
                ),
                'testmode' => array(
                    'title' => __('PayPal Sandbox', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Sandbox', 'paypal-advanced-for-woocommerce'),
                    'default' => 'no',
                    'description' => __('Check this box to enable test mode so that all transactions will hit PayPal’s sandbox server instead of the live server. This should only be used during development as no real transactions will occur when this is enabled.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true
                ),
                'live_onboarding' => array(
                    'title' => __('Connect to PayPal', 'paypal-advanced-for-woocommerce'),
                    'type' => 'goopter_ppcp_onboarding',
                    'gateway' => 'goopter_ppcp',
                    'mode' => 'live',
                    'description' => __('Setup or link an existing PayPal account.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => ''
                ),
                'live_disconnect' => array(
                    'title' => __('PayPal Connection', 'paypal-advanced-for-woocommerce'),
                    'type' => 'goopter_ppcp_text',
                    'mode' => 'live',
                    'description' => __('Click to reset current credentials and use another account.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => '',
                ),
                'sandbox_onboarding' => array(
                    'title' => __('Connect to PayPal Sandbox', 'paypal-advanced-for-woocommerce'),
                    'type' => 'goopter_ppcp_onboarding',
                    'gateway' => 'goopter_ppcp',
                    'mode' => 'sandbox',
                    'description' => __('Setup or link an existing PayPal account.', 'paypal-advanced-for-woocommerce'),
                ...
                'api_client_id' => array(
                    'title' => __('PayPal Client ID', 'paypal-advanced-for-woocommerce'),
                    'type' => 'password',
                    'description' => __('Enter your PayPal Client ID.', 'paypal-advanced-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true
                ),
                'api_secret' => array(
                    'title' => __('PayPal Secret', 'paypal-advanced-for-woocommerce'),
                    'type' => 'password',
                    'description' => __('Enter your PayPal Secret.', 'paypal-advanced-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true
                ),
                'live_merchant_id' => array(
                    'title' => __('Live Merchant ID', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => '',
                    'default' => '',
                ...
                'sandbox_client_id' => array(
                    'title' => __('Sandbox Client ID', 'paypal-advanced-for-woocommerce'),
                    'type' => 'password',
                    'description' => __('Enter your PayPal Sandbox Client ID.', 'paypal-advanced-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true
                ),
                'sandbox_api_secret' => array(
                    'title' => __('Sandbox Secret', 'paypal-advanced-for-woocommerce'),
                    'type' => 'password',
                    'description' => __('Enter your PayPal Sandbox Secret.', 'paypal-advanced-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true
                ),
                'sandbox_merchant_id' => array(
                    'title' => __('Sandbox Merchant ID', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => '',
                    'default' => '',
                    'custom_attributes' => array('readonly' => 'readonly'),
                ...
                'product_button_settings' => array(
                    'title' => __('Product Page Settings', 'paypal-advanced-for-woocommerce'),
                    'description' => __('Enable the Product specific button settings, and the options set will be applied to the PayPal Smart buttons on your Product pages.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                    'class' => 'ppcp_separator_heading',
                ),
                'enable_product_button' => array(
                    ...
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Smart Button on the Product Pages.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'yes',
                    'desc_tip' => true,
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                ),
                'product_disallowed_funding_methods' => array(
                    'title' => __('Hide Funding Method(s)', 'paypal-advanced-for-woocommerce'),
                    'type' => 'multiselect',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Funding methods selected here will be hidden from buyers during checkout.', 'paypal-advanced-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
                    'options' => array(
                        'card' => __('Credit or Debit Card', 'paypal-advanced-for-woocommerce'),
                        'credit' => __('PayPal Credit', 'paypal-advanced-for-woocommerce'),
                        'paylater' => __('Pay Later', 'paypal-advanced-for-woocommerce'),
                ...
                'product_button_layout' => array(
                    'title' => __('Button Layout', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Select Vertical for stacked buttons, and Horizontal for side-by-side buttons.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'horizontal',
                    'desc_tip' => true,
                    'options' => array(
                        'horizontal' => __('Horizontal (Recommended)', 'paypal-advanced-for-woocommerce'),
                        'vertical' => __('Vertical', 'paypal-advanced-for-woocommerce')
                    ),
                ),
                'product_style_color' => array(
                    'title' => __('Button Color', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the color you would like to use for the PayPal button.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                    'default' => 'gold',
                    'options' => array(
                        'gold' => __('Gold (Recommended)', 'paypal-advanced-for-woocommerce'),
                        'blue' => __('Blue', 'paypal-advanced-for-woocommerce'),
                        'silver' => __('Silver', 'paypal-advanced-for-woocommerce'),
                        'white' => __('White', 'paypal-advanced-for-woocommerce'),
                        'black' => __('Black', 'paypal-advanced-for-woocommerce')
                    ),
                ),
                'product_style_shape' => array(
                    'title' => __('Button Shape', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the shape you would like to use for the buttons.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                    'default' => 'rect',
                    'options' => array(
                        'rect' => __('Rect (Recommended)', 'paypal-advanced-for-woocommerce'),
                        'pill' => __('Pill', 'paypal-advanced-for-woocommerce')
                    ),
                ),
                'product_button_size' => array(
                    'title' => __('Button Size', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the size of the buttons you would like displayed. Responsive will fit to the current element on the page.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'responsive',
                    'desc_tip' => true,
                    'options' => array(
                        'small' => __('Small', 'paypal-advanced-for-woocommerce'),
                        'medium' => __('Medium', 'paypal-advanced-for-woocommerce'),
                        'large' => __('Large', 'paypal-advanced-for-woocommerce'),
                        'responsive' => __('Responsive (Recommended)', 'paypal-advanced-for-woocommerce'),
                    ),
                ),
                'product_button_height' => array(
                    'title' => __('Button Height', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the height of the buttons you would like displayed.', 'paypal-advanced-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
                    'options' => $button_height,
                ),
                'product_button_label' => array(
                    'title' => __('Button Label', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the label type you would like to use for the PayPal button.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'paypal',
                    'desc_tip' => true,
                    'options' => array(
                        'paypal' => __('PayPal (Recommended)', 'paypal-advanced-for-woocommerce'),
                        'checkout' => __('Checkout', 'paypal-advanced-for-woocommerce'),
                        'buynow' => __('Buy Now', 'paypal-advanced-for-woocommerce'),
                        'pay' => __('Pay', 'paypal-advanced-for-woocommerce'),
                    ),
                ),
                'product_button_tagline' => array(
                    'title' => __('Tagline', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                    'class' => 'goopter_ppcp_product_button_settings',
                    'default' => 'yes',
                    'label' => __('Enable tagline', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                    'description' => __(
                            'Add the tagline. This line will only show up, if you select a horizontal layout.', 'paypal-advanced-for-woocommerce'
                    ),
                ),
                'product_button_width' => array(
                    'title' => __('Buttons Width', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the width of the buttons (e.g. PayPal, Apple Pay, Google Pay) you would like displayed.', 'paypal-advanced-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
                    'options' => $button_width,
                ),
                'product_google_style_color' => array(
                    'title' => __('Google Pay Button Color', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the color you would like to use for the Google Pay button.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                    'default' => 'default',
                    'options' => array(
                        'default' => __('Default (Recommended)', 'paypal-advanced-for-woocommerce'),
                        'black' => __('Black', 'paypal-advanced-for-woocommerce'),
                        'white' => __('White', 'paypal-advanced-for-woocommerce'),
                    ),
                ),
                'product_google_button_type' => array(
                    'title' => __('Google Pay Button Type', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the color you would like to use for the Google Pay button.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ...
                'product_google_button_height' => array(
                    'title' => __('Google Pay Button Height', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the height of the Google Pay button you would like displayed.', 'paypal-advanced-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
                    'options' => $button_height,
                ),
                'product_apple_style_color' => array(
                    'title' => __('Apple Pay Button Color', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the color you would like to use for the Apple Pay button.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                    'default' => 'default',
                    'options' => array(
                        'black' => __('Black (Recommended)', 'paypal-advanced-for-woocommerce'),
                        'white' => __('White', 'paypal-advanced-for-woocommerce'),
                        'white-outline' => __('White Outline', 'paypal-advanced-for-woocommerce'),
                    ),
                ),
                'product_apple_button_type' => array(
                    'title' => __('Apple Pay Button Type', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the color you would like to use for the Apple Pay button.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ...
                'product_apple_button_height' => array(
                    'title' => __('Apple Pay Button Height', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select goopter_ppcp_product_button_settings',
                    'description' => __('Set the height of the Apple Pay button you would like displayed.', 'paypal-advanced-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
                    'options' => $button_height,
                ),
                'cart_button_settings' => array(
                    'title' => __('Cart Page Settings', 'paypal-advanced-for-woocommerce'),
                    'description' => __('Enable the Cart specific button settings, and the options set will be applied to the PayPal buttons on your Cart page.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                    'class' => 'ppcp_separator_heading',
                ),
                'enable_cart_button' => array(
                    ...
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Smart Button on the Cart page.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'yes',
                    'desc_tip' => true,
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                ...
                'cart_button_layout' => array(
                    ...
                    'desc_tip' => true,
                    'options' => array(
                        'vertical' => __('Vertical (Recommended)', 'paypal-advanced-for-woocommerce'),
                        'horizontal' => __('Horizontal', 'paypal-advanced-for-woocommerce'),
                    ),
                ),
                ...
                'checkout_button_settings' => array(
                    'title' => __('Checkout Page Settings', 'paypal-advanced-for-woocommerce'),
                    'description' => __('Enable the checkout specific button settings, and the options set will be applied to the PayPal buttons on your checkout page.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                    'class' => 'ppcp_separator_heading',
                ),
                'enable_paypal_checkout_page' => array(
                    ...
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Payments on the Checkout page.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'yes',
                    'desc_tip' => true,
                    'description' => __('if this option is disable, PayPal will be not display in checkout page.', 'paypal-advanced-for-woocommerce'),
                ),
                'checkout_page_display_option' => array(
                    'title' => __('Checkout Page Display', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'options' => array(
                ...
                'checkout_disable_smart_button' => array(
                    ...
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Disable smart buttons in the regular list of payment gateways.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'no',
                    'desc_tip' => true,
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                ...
                'checkout_button_label' => array(
                    ...
                    'desc_tip' => true,
                    'options' => array(
                        'paypal' => __('PayPal', 'paypal-advanced-for-woocommerce'),
                        'checkout' => __('Checkout', 'paypal-advanced-for-woocommerce'),
                        'buynow' => __('Buy Now', 'paypal-advanced-for-woocommerce'),
                        'pay' => __('Pay', 'paypal-advanced-for-woocommerce'),
                    ),
                ...
                'mini_cart_button_settings' => array(
                    'title' => __('Mini Cart Page Settings', 'paypal-advanced-for-woocommerce'),
                    'description' => __('Enable the Mini Cart specific button settings, and the options set will be applied to the PayPal buttons on your Mini Cart page.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                    'class' => 'ppcp_separator_heading',
                ),
                'enable_mini_cart_button' => array(
                    ...
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Smart Button on the Mini Cart page.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'yes',
                    'desc_tip' => true,
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                ...
                'pay_later_messaging_settings' => array(
                    'title' => __('Pay Later Messaging Settings', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                    'type' => 'title',
                    'class' => 'ppcp_separator_heading',
                ),
                'enabled_pay_later_messaging' => array(
                    'title' => __('Enable/Disable', 'paypal-advanced-for-woocommerce'),
                    'label' => __('Enable Pay Later Messaging', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                ...
                'pay_later_messaging_page_type' => array(
                    'title' => __('Page Type', 'paypal-advanced-for-woocommerce'),
                    'type' => 'multiselect',
                    'css' => 'width: 100%;',
                    'class' => 'wc-enhanced-select pay_later_messaging_field',
                    'default' => array('product', 'cart', 'payment'),
                    'options' => array('home' => __('Home', 'paypal-advanced-for-woocommerce'), 'category' => __('Category', 'paypal-advanced-for-woocommerce'), 'product' => __('Product', 'paypal-advanced-for-woocommerce'), 'cart' => __('Cart', 'paypal-advanced-for-woocommerce'), 'payment' => __('Payment', 'paypal-advanced-for-woocommerce')),
                ...
                'pay_later_messaging_home_page_settings' => array(
                    'title' => __('Home Page', 'paypal-advanced-for-woocommerce'),
                    'class' => 'pay_later_messaging_field pay_later_messaging_home_field',
                    'description' => __('Customize the appearance of <a target="_blank" href="https://www.paypal.com/us/business/buy-now-pay-later">Pay Later Messaging</a> on the Home page to promote special financing offers which help increase sales.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                ),
                'pay_later_messaging_home_layout_type' => array(
                    'title' => __('Layout Type', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    ...
                    'default' => 'flex',
                    'desc_tip' => true,
                    'options' => array('text' => __('Text Layout', 'paypal-advanced-for-woocommerce'), 'flex' => __('Flex Layout', 'paypal-advanced-for-woocommerce'))
                ),
                'pay_later_messaging_home_text_layout_logo_type' => array(
                    'title' => __('Logo Type', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    ...
                    'default' => 'primary',
                    'desc_tip' => true,
                    'options' => array('primary' => __('Primary', 'paypal-advanced-for-woocommerce'), 'alternative' => __('Alternative', 'paypal-advanced-for-woocommerce'), 'inline' => __('Inline', 'paypal-advanced-for-woocommerce'), 'none' => __('None', 'paypal-advanced-for-woocommerce'))
                ),
                'pay_later_messaging_home_text_layout_logo_position' => array(
                    'title' => __('Logo Position', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select pay_later_messaging_field pay_later_messaging_home_field pay_later_messaging_home_text_layout_field',
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                    'default' => 'left',
                    'desc_tip' => true,
                    'options' => array('left' => __('Left', 'paypal-advanced-for-woocommerce'), 'right' => __('Right', 'paypal-advanced-for-woocommerce'), 'top' => __('Top', 'paypal-advanced-for-woocommerce'))
                ),
                'pay_later_messaging_home_text_layout_text_size' => array(
                    'title' => __('Text Size', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select pay_later_messaging_field pay_later_messaging_home_field pay_later_messaging_home_text_layout_field',
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                    'default' => '12',
                    'desc_tip' => true,
                    'options' => array('10' => __('10 px', 'paypal-advanced-for-woocommerce'), '11' => __('11 px', 'paypal-advanced-for-woocommerce'), '12' => __('12 px', 'paypal-advanced-for-woocommerce'), '13' => __('13 px', 'paypal-advanced-for-woocommerce'), '14' => __('14 px', 'paypal-advanced-for-woocommerce'), '15' => __('15 px', 'paypal-advanced-for-woocommerce'), '16' => __('16 px', 'paypal-advanced-for-woocommerce'))
                ),
                'pay_later_messaging_home_text_layout_text_color' => array(
                    'title' => __('Text Color', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select pay_later_messaging_field pay_later_messaging_home_field pay_later_messaging_home_text_layout_field',
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                    'default' => 'black',
                    'desc_tip' => true,
                    'options' => array('black' => __('Black', 'paypal-advanced-for-woocommerce'), 'white' => __('White', 'paypal-advanced-for-woocommerce'), 'monochrome' => __('Monochrome', 'paypal-advanced-for-woocommerce'), 'grayscale' => __('Grayscale', 'paypal-advanced-for-woocommerce'))
                ),
                'pay_later_messaging_home_flex_layout_color' => array(
                    'title' => __('Color', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    ...
                    'default' => 'blue',
                    'desc_tip' => true,
                    'options' => array('blue' => __('Blue', 'paypal-advanced-for-woocommerce'), 'black' => __('Black', 'paypal-advanced-for-woocommerce'), 'white' => __('White', 'paypal-advanced-for-woocommerce'), 'white-no-border' => __('White (No Border)', 'paypal-advanced-for-woocommerce'), 'gray' => __('Gray', 'paypal-advanced-for-woocommerce'), 'monochrome' => __('Monochrome', 'paypal-advanced-for-woocommerce'), 'grayscale' => __('Grayscale', 'paypal-advanced-for-woocommerce'))
                ),
                'pay_later_messaging_home_flex_layout_ratio' => array(
                    'title' => __('Ratio', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select pay_later_messaging_field pay_later_messaging_home_field pay_later_messaging_home_flex_layout_field',
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                    'default' => '8x1',
                    'desc_tip' => true,
                    'options' => array('1x1' => __('Flexes between 120px and 300px wide', 'paypal-advanced-for-woocommerce'), '1x4' => __('160px wide', 'paypal-advanced-for-woocommerce'), '8x1' => __('Flexes between 250px and 768px wide', 'paypal-advanced-for-woocommerce'), '20x1' => __('Flexes between 250px and 1169px wide', 'paypal-advanced-for-woocommerce'))
                ),
                'pay_later_messaging_home_shortcode' => array(
                    'title' => __('Enable/Disable', 'paypal-advanced-for-woocommerce'),
                    'label' => __('I need a shortcode so that I can place the message in a better spot on Home page.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                ...
                'pay_later_messaging_home_preview_shortcode' => array(
                    'title' => __('Shortcode', 'paypal-advanced-for-woocommerce'),
                    'type' => 'copy_text',
                ...
                'pay_later_messaging_category_page_settings' => array(
                    'title' => __('Category Page', 'paypal-advanced-for-woocommerce'),
                    'description' => __('Customize the appearance of <a target="_blank" href="https://www.paypal.com/us/business/buy-now-pay-later">Pay Later Messaging</a> on the Category page to promote special financing offers which help increase sales.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                ...
                'pay_later_messaging_category_shortcode' => array(
                    'title' => __('Enable/Disable', 'paypal-advanced-for-woocommerce'),
                    'label' => __('I need a shortcode so that I can place the message in a better spot on category page.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                ...
                'pay_later_messaging_product_page_settings' => array(
                    'title' => __('Product Page', 'paypal-advanced-for-woocommerce'),
                    'description' => __('Customize the appearance of <a target="_blank" href="https://www.paypal.com/us/business/buy-now-pay-later">Pay Later Messaging</a> on the Product page to promote special financing offers which help increase sales.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                ...
                'pay_later_messaging_product_shortcode' => array(
                    'title' => __('Enable/Disable', 'paypal-advanced-for-woocommerce'),
                    'label' => __('I need a shortcode so that I can place the message in a better spot on product page.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                ...
                'pay_later_messaging_cart_page_settings' => array(
                    'title' => __('Cart Page', 'paypal-advanced-for-woocommerce'),
                    'description' => __('Customize the appearance of <a target="_blank" href="https://www.paypal.com/us/business/buy-now-pay-later">Pay Later Messaging</a> on the Cart page to promote special financing offers which help increase sales.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                ...
                'pay_later_messaging_cart_shortcode' => array(
                    'title' => __('Enable/Disable', 'paypal-advanced-for-woocommerce'),
                    'label' => __('I need a shortcode so that I can place the message in a better spot on cart page.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                ...
                'pay_later_messaging_payment_page_settings' => array(
                    'title' => __('Payment Page', 'paypal-advanced-for-woocommerce'),
                    'description' => __('Customize the appearance of <a target="_blank" href="https://www.paypal.com/us/business/buy-now-pay-later">Pay Later Messaging</a> on the Payment page to promote special financing offers which help increase sales.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                ...
                'pay_later_messaging_payment_shortcode' => array(
                    'title' => __('Enable/Disable', 'paypal-advanced-for-woocommerce'),
                    'label' => __('I need a shortcode so that I can place the message in a better spot on payment page.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                ...
                'tokenization_subscriptions' => array(
                    'title' => __('Tokenization / Subscriptions', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                    'description' => '',
                    'class' => 'ppcp_separator_heading',
                ),
                'enable_tokenized_payments' => array(
                    'title' => __('Enable Tokenized Payments', 'paypal-advanced-for-woocommerce'),
                    'label' => __('Enable Tokenized Payments', 'paypal-advanced-for-woocommerce'),
                ...
                'apple_pay_authorizations' => array(
                    'title' => __('Apple Pay', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                    'description' => '',
                    'class' => 'ppcp_separator_heading',
                ),
                'enable_apple_pay' => array(
                    'title' => __('Enable Apple Pay', 'paypal-advanced-for-woocommerce'),
                    'label' => __('Enable Apple Pay', 'paypal-advanced-for-woocommerce'),
                ...
                'apple_pay_payments_title' => array(
                    'title' => __('Apple Pay Title', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('This controls the title which the user sees during checkout.', 'paypal-advanced-for-woocommerce'),
                    'default' => __('Apple Pay', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ),
                'apple_pay_payments_description' => array(
                    'title' => __('Apple Pay Payment Description', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('This controls the description which the user sees when they select Apple Pay payment method during checkout.', 'paypal-advanced-for-woocommerce'),
                    'default' => __('Accept payments using Apple Pay.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ),
                'apple_pay_rec_payment_desc' => array(
                    'title' => __('Apple Pay Billing Agreement Title', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('A description of the recurring payment that Apple Pay displays to the user in the payment sheet.', 'paypal-advanced-for-woocommerce'),
                    'default' => __('Billing Agreement', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ),
                'apple_pay_rec_billing_agreement_desc' => array(
                    'title' => __('Apple Pay Billing Agreement Description', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('A localized billing agreement that the payment sheet displays to the user before the user authorizes the payment.', 'paypal-advanced-for-woocommerce'),
                    'default' => __('Billing Agreement', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ),
                'google_pay_authorizations' => array(
                    'title' => __('Google Pay', 'paypal-advanced-for-woocommerce'),
                    'class' => 'ppcp_separator_heading',
                    'type' => 'title',
                ),
                'enable_google_pay' => array(
                    'title' => __('Enable Google Pay', 'paypal-advanced-for-woocommerce'),
                    'label' => __('Enable Google Pay', 'paypal-advanced-for-woocommerce'),
                ...
                'google_pay_payments_title' => array(
                    'title' => __('Google Pay Title', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('This controls the title which the user sees during checkout.', 'paypal-advanced-for-woocommerce'),
                    'default' => __('Google Pay', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ),
                'google_pay_payments_description' => array(
                    'title' => __('Google Pay Payment Description', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('This controls the description which the user sees when they select Google Pay payment method during checkout.', 'paypal-advanced-for-woocommerce'),
                    'default' => __('Accept payments using Google Pay.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                ),
                'woo_pre_order' => array(
                    'title' => __('WooCommerce Pre-Orders Settings', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                    'description' => '',
                    'class' => 'ppcp_separator_heading',
                ),
                'woo_pre_order_payment_mode' => array(
                    'title' => __('Pre-Orders Payment Mode', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select',
                    'description' => __('Choose whether you wish to Auth/capture OR PayPal Vault.', 'paypal-advanced-for-woocommerce'),
                    'default' => $this->is_paypal_vault_enable ? 'vault' : 'authorize',
                    'desc_tip' => true,
                    'options' => $this->woo_pre_order_payment_mode,
                ),
                'advanced_settings' => array(
                    'title' => __('Advanced Settings', 'paypal-advanced-for-woocommerce'),
                    'type' => 'title',
                    'description' => '',
                    'class' => 'ppcp_separator_heading',
                ),
                'paymentaction' => array(
                    'title' => __('Payment Action', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select',
                    'description' => __('Choose whether you wish to capture funds immediately or authorize payment only.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'capture',
                    'desc_tip' => true,
                    'options' => $paymentaction_options,
                ),
                'auto_capture_auth' => array(
                    'title' => __('Automatic Capture of Pending Authorizations', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                    'label' => __('Automatically capture a pending authorization when the order status is updated to Processing or Completed.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'yes',
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                    'desc_tip' => true
                ...
                'paymentstatus' => array(
                    'title' => __('Order Status', 'paypal-advanced-for-woocommerce'),
                    'description' => __('Select the status you wish to apply after the successful order. The default setting adheres to WooCommerce rules for order status.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select',
                    'default' => 'wc-default',
                    'desc_tip' => true,
                ...
                'invoice_prefix' => array(
                    'title' => __('Invoice Prefix', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('Please enter a prefix for your invoice numbers. If you use your PayPal account for multiple stores ensure this prefix is unique as PayPal will not allow orders with the same invoice number.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'GT-PPCP',
                    'desc_tip' => true,
                ),
                ...
                'order_review_page_enable_coupons' => array(
                    'title' => __('Coupon Codes', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                    'label' => __('Enable the use of coupon codes on the final review page.', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                    'default' => 'yes',
                ),
                'disable_term' => array(
                ...
                'landing_page' => array(
                    'title' => __('Landing Page', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select',
                    'description' => __('The type of landing page to show on the PayPal site for customer checkout. PayPal Account Optional must be checked for this option to be used.', 'paypal-advanced-for-woocommerce'),
                    'options' => array('LOGIN' => __('Login', 'paypal-advanced-for-woocommerce'),
                        'BILLING' => __('Billing', 'paypal-advanced-for-woocommerce'),
                        'NO_PREFERENCE' => __('No Preference', 'paypal-advanced-for-woocommerce')),
                    'default' => 'NO_PREFERENCE',
                    'desc_tip' => true,
                ),
                'payee_preferred' => array(
                    'title' => __('Instant Payments ', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                    'default' => 'no',
                    'desc_tip' => true,
                    'description' => __(
                            'If you enable this setting, PayPal will be instructed not to allow the buyer to use funding sources that take additional time to complete (for example, eChecks). Instead, the buyer will be required to use an instant funding source, such as an instant transfer, a credit/debit card, or PayPal Credit.', 'paypal-advanced-for-woocommerce'
                    ),
                    'label' => __('Require Instant Payment', 'paypal-advanced-for-woocommerce'),
                ),
                'set_billing_address' => array(
                    'title' => __('Billing Address', 'paypal-advanced-for-woocommerce'),
                    'label' => __('Set billing address in WooCommerce using the address returned by PayPal.', 'paypal-advanced-for-woocommerce'),
                    'description' => __('This does not apply when a billing address is provided by WooCommerce through the checkout page or from a logged in user profile.', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                    'default' => 'yes',
                    'desc_tip' => false,
                ),
                'send_items' => array(
                    'title' => __('Send Item Details', 'paypal-advanced-for-woocommerce'),
                    'label' => __('Send line item details to PayPal', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                    'description' => __('Include all line item details in the payment request to PayPal so that they can be seen from the PayPal transaction details page.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'yes'
                ),
                'enable_advanced_card_payments' => array(
                    'title' => __('Advanced Credit Cards', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                    'label' => __('Enable advanced credit and debit card payments.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'no',
                ...
                '3d_secure_contingency' => array(
                    'title' => __('Contingency for 3D Secure', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select advanced_cc_fields_group',
                    'options' => array(
                        'SCA_WHEN_REQUIRED' => __('3D Secure when required', 'paypal-advanced-for-woocommerce'),
                        'SCA_ALWAYS' => __('Always trigger 3D Secure', 'paypal-advanced-for-woocommerce'),
                    ),
                    'default' => 'SCA_WHEN_REQUIRED',
                    'desc_tip' => true,
                    'description' => __('3D Secure benefits cardholders and merchants by providing an additional layer of verification using Verified by Visa, MasterCard SecureCode and American Express SafeKey.', 'paypal-advanced-for-woocommerce'),
                ),
                'advanced_card_payments_title' => array(
                    'title' => __('Advanced Credit Cards Title', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('This controls the title which the user sees during checkout.', 'paypal-advanced-for-woocommerce'),
                    'default' => __('Credit Card', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true,
                    'class' => 'advanced_cc_fields_group'
                ),
                'advanced_card_payments_display_position' => array(
                    'title' => __('Advanced Credit Cards Position', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select advanced_cc_fields_group',
                    'options' => array(
                        'before' => __('Before PayPal Smart Button', 'paypal-advanced-for-woocommerce'),
                        'after' => __('After PayPal Smart Button', 'paypal-advanced-for-woocommerce'),
                    ),
                    'default' => 'before',
                    'desc_tip' => true,
                    'description' => __('This controls the gateway position which the user sees during checkout.', 'paypal-advanced-for-woocommerce'),
                ),
                'disable_cards' => array(
                    'title' => __('Disable specific credit cards', 'paypal-advanced-for-woocommerce'),
                    'type' => 'multiselect',
                    'class' => 'wc-enhanced-select advanced_cc_fields_group',
                    'default' => array(),
                    'desc_tip' => true,
                ...
                'cards_input_size' => array(
                    'title' => __('Card Text Size', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select advanced_cc_fields_group',
                    'default' => '',
                    'desc_tip' => true,
                    'description' => __('Choose the font size for the field.', 'paypal-advanced-for-woocommerce'),
                    'options' => $this->get_size_listing(10, 50, 2, 'px')
                ),
                'cards_input_color' => array(
                    'title' => __('Card Text Color', 'paypal-advanced-for-woocommerce'),
                    'type' => 'color_picker',
                    'class' => 'advanced_cc_fields_group',
                    'default' => '#000000',
                    'desc_tip' => true,
                ...
                'cards_input_style' => array(
                    'title' => __('Card Text Style', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select advanced_cc_fields_group',
                    'default' => 'normal',
                    'desc_tip' => true,
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                    'options' => array('normal' => __('Normal', 'paypal-advanced-for-woocommerce'), 'italic' => __('Italic', 'paypal-advanced-for-woocommerce'), 'inherit' => __('Inherit', 'paypal-advanced-for-woocommerce'), 'revert' => __('Revert', 'paypal-advanced-for-woocommerce'))
                ),
                'cards_input_weight' => array(
                    'title' => __('Card Text Weight', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select advanced_cc_fields_group',
                    'default' => '',
                    'desc_tip' => true,
                    // 'description' => __('', 'paypal-advanced-for-woocommerce'),
                    'description' => '',
                    'options' => array('' => __('Default', 'paypal-advanced-for-woocommerce'), '100' => __('100', 'paypal-advanced-for-woocommerce'), '200' => __('200', 'paypal-advanced-for-woocommerce'), '300' => __('300', 'paypal-advanced-for-woocommerce'), '400' => __('400', 'paypal-advanced-for-woocommerce'), '500' => __('500', 'paypal-advanced-for-woocommerce'), '600' => __('600', 'paypal-advanced-for-woocommerce'), 'bold' => __('Bold', 'paypal-advanced-for-woocommerce'))
                ),
                'cards_input_padding' => array(
                    'title' => __('Card Text Padding', 'paypal-advanced-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select advanced_cc_fields_group',
                    'default' => '',
                    'desc_tip' => true,
                ...
                'soft_descriptor' => array(
                    'title' => __('Credit Card Statement Name', 'paypal-advanced-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('The value entered here will be displayed on the buyer\'s credit card statement.', 'paypal-advanced-for-woocommerce'),
                    'default' => substr(get_bloginfo('name'), 0, 21),
                    'desc_tip' => true,
                    'custom_attributes' => array('maxlength' => '22'),
                ),
                'error_email_notification' => array(
                    'title' => __('Error Email Notifications', 'paypal-advanced-for-woocommerce'),
                    'type' => 'checkbox',
                    'label' => __('Enable admin email notifications for errors.', 'paypal-advanced-for-woocommerce'),
                    'default' => 'yes',
                    'description' => __('This will send a detailed error email to the WordPress site administrator if a PayPal API error occurs.', 'paypal-advanced-for-woocommerce'),
                    'desc_tip' => true
                ),
                'debug' => array(
                    ...
                    'options' => array(
                        ...
                        'errors_warnings_only' => __('Errors and Warnings Only', 'paypal-advanced-for-woocommerce'),
                        'disabled' => __('Disabled', 'paypal-advanced-for-woocommerce')
                    ),
                    'default' => 'everything'
                )
            );
