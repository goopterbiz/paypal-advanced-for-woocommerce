...
class WC_Gateway_Apple_Pay_Goopter extends WC_Gateway_PPCP_Goopter {
    ...
    public function __construct() {
        ...
        try {
            ...
            $this->method_description = __('Accept payments using Apple Pay.', 'advanced-paypal-complete-payments-for-woocommerce');
    ...
    public function form() {
        try {
            ?>
            <?php 
                $description = $this->apple_pay_payments_description ?: __('Default Apple Pay description', 'advanced-paypal-complete-payments-for-woocommerce');
