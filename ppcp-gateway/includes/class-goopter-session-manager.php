...
/**
 * Goopter Session Manager
 * This class stores the data related to PPCP checkout process to support the payments
 */
class Goopter_Session_Manager
{
    private static ?Goopter_Session_Manager $instance = null;
    private string $sessionName = 'goopter_ppcp_session';
    private ?array $_data = null;

    public static function instance(): Goopter_Session_Manager
    {
