...
final class Goopter_PPCP_Checkout_Block extends AbstractPaymentMethodType {
    ...
    public function get_payment_method_script_handles() {
        ...
        if (goopter_ppcp_has_active_session()) {
            $order_button_text = apply_filters('goopter_ppcp_order_review_page_place_order_button_text', __('Confirm Your Order', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment'));
        } else {
        ...
        if (function_exists('wp_set_script_translations')) {
            wp_set_script_translations('goopter_ppcp-blocks-integration', 'goopter-advanced-payment-for-woocommerce-and-paypal-complete-payment');
        }
