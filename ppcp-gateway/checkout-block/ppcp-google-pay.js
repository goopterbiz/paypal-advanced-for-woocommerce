...
(function (e) {
    ...
    ,
            function (e, t, n) {
                ...
                const l = Object(u.getSetting)("goopter_ppcp_google_pay_data", {});
                ...
                const s = {
                    ...
                    placeOrderButtonLabel: Object(i.__)(goopter_ppcp_google_pay_manager_block.placeOrderButtonLabel),
...
const ppcp_google_uniqueEvents = new Set([
...
ppcp_google_uniqueEvents.forEach(function (action) {
