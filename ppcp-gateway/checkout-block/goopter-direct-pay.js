...
(function (e) {
    ...
    function (e, t, n) {
        ...
        const l = Object(u.getSetting)("goopter_direct_pay_data", {});
        const iconsElements = createElement("img", {key: l.icon, src: l.icon, style: {float: "right", marginRight: "10px"}});
        console.log("iconsElements", iconsElements);
        const p = () => Object(a.decodeEntities)(l.description || "");
        const ppcp_settings = goopter_direct_pay_manager_block.settins;
        const {is_order_confirm_page, is_paylater_enable_incart_page, page} = goopter_direct_pay_manager_block;
        const {useEffect} = window.wp.element;

        const Content_Goopter_Direct_Pay = (props) => {
            ...
            return createElement("div",{ className: "goopter_direct_pay_container goopter_direct_pay_container_hide" });
        };
        
        const s = {
            name: "goopter_direct_pay",
            label: createElement(
                    "span",
                    {style: {width: "100%"}},
                    l.title,
                    ...
                    placeOrderButtonLabel: Object(i.__)(goopter_direct_pay_manager_block.placeOrderButtonLabel),
            content: createElement(Content_Goopter_Direct_Pay, null),
            edit: Object(r.createElement)(p, null),
            canMakePayment: () => Promise.resolve(true),
            ariaLabel: Object(a.decodeEntities)(l.cc_title || Object(i.__)("Payment via Clover", "woo-gutenberg-products-block")),
            supports: {
...
const goopter_direct_pay_uniqueEvents = new Set([
...
goopter_direct_pay_uniqueEvents.forEach(function (action) {
