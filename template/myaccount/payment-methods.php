...
<?php else : ?>
    ...
    <p class="woocommerce-Message woocommerce-Message--info woocommerce-info"><?php esc_html_e('No saved methods found.', 'goopter-advanced-paypal-complete-payments-for-woocommerce'); ?></p>
...
<?php if ($available_payment_gateways) : ?>
    <a class="button" href="<?php echo esc_url(wc_get_endpoint_url('add-payment-method')); ?>"><?php esc_html_e('Add payment method', 'goopter-advanced-paypal-complete-payments-for-woocommerce'); ?></a>
<?php endif; ?>
