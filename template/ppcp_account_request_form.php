    ...
    <div class="ppcp_account_request-Modal-header">
        <div>
            <button class="ppcp_account_request-Modal-return ppcp_account_request-icon-chevron-left">
                <?php esc_html_e( 'Return', 'goopter-advanced-paypal-complete-payments-for-woocommerce' ); ?>
            </button>
            <h2>
                <?php esc_html_e( 'PPCP Account Request', 'goopter-advanced-paypal-complete-payments-for-woocommerce' ); ?>
            </h2>
        </div>
        <button class="ppcp_account_request-Modal-close ppcp_account_request-icon-close">
            <?php esc_html_e( 'Close', 'goopter-advanced-paypal-complete-payments-for-woocommerce' ); ?>
        </button>
    </div>
