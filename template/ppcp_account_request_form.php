...
<div class="ppcp_account_request-Modal" style="display: none;">
    <div class="ppcp_account_request-Modal-header">
        <div>
            <button class="ppcp_account_request-Modal-return ppcp_account_request-icon-chevron-left"><?php _e('Return', 'paypal-advanced-for-woocommerce'); ?></button>
            <h2><?php _e('PPCP Account Request', 'paypal-advanced-for-woocommerce'); ?></h2>
        </div>
        <button class="ppcp_account_request-Modal-close ppcp_account_request-icon-close"><?php _e('Close', 'paypal-advanced-for-woocommerce'); ?></button>
    </div>
